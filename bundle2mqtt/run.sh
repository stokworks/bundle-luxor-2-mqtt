...
export WEATHER_ENABLED=$(bashio::config 'weather_enabled')
export WEATHER_NAME=$(bashio::config 'weather_name')
export WEATHER_WIND_SPEED_ENABLED=$(bashio::config 'weather_wind_speed_enabled')
export WEATHER_WIND_SPEED_NAME=$(bashio::config 'weather_wind_speed_name')
export WEATHER_WIND_SPEED_DATAPOINT=$(bashio::config 'weather_wind_speed_datapoint')
export WEATHER_WIND_ALARM_1_ENABLED=$(bashio::config 'weather_wind_alarm_1_enabled')
export WEATHER_WIND_ALARM_1_NAME=$(bashio::config 'weather_wind_alarm_1_name')
export WEATHER_WIND_ALARM_1_DATAPOINT=$(bashio::config 'weather_wind_alarm_1_datapoint')
export WEATHER_WIND_ALARM_2_ENABLED=$(bashio::config 'weather_wind_alarm_2_enabled')
export WEATHER_WIND_ALARM_2_NAME=$(bashio::config 'weather_wind_alarm_2_name')
export WEATHER_WIND_ALARM_2_DATAPOINT=$(bashio::config 'weather_wind_alarm_2_datapoint')
export WEATHER_OUTSIDE_TEMP_ENABLED=$(bashio::config 'weather_outside_temp_enabled')
export WEATHER_OUTSIDE_TEMP_NAME=$(bashio::config 'weather_outside_temp_name')
export WEATHER_OUTSIDE_TEMP_DATAPOINT=$(bashio::config 'weather_outside_temp_datapoint')
export WEATHER_FROST_ALARM_ENABLED=$(bashio::config 'weather_frost_alarm_enabled')
export WEATHER_FROST_ALARM_NAME=$(bashio::config 'weather_frost_alarm_name')
export WEATHER_FROST_ALARM_DATAPOINT=$(bashio::config 'weather_frost_alarm_datapoint')
export WEATHER_RAIN_ALARM_ENABLED=$(bashio::config 'weather_rain_alarm_enabled')
export WEATHER_RAIN_ALARM_NAME=$(bashio::config 'weather_rain_alarm_name')
export WEATHER_RAIN_ALARM_DATAPOINT=$(bashio::config 'weather_rain_alarm_datapoint')
export WEATHER_ILLUMINANCE_1_ENABLED=$(bashio::config 'weather_illuminance_1_enabled')
export WEATHER_ILLUMINANCE_1_NAME=$(bashio::config 'weather_illuminance_1_name')
export WEATHER_ILLUMINANCE_1_DATAPOINT=$(bashio::config 'weather_illuminance_1_datapoint')
export WEATHER_ILLUMINANCE_2_ENABLED=$(bashio::config 'weather_illuminance_2_enabled')
export WEATHER_ILLUMINANCE_2_NAME=$(bashio::config 'weather_illuminance_2_name')
export WEATHER_ILLUMINANCE_2_DATAPOINT=$(bashio::config 'weather_illuminance_2_datapoint')
export WEATHER_ILLUMINANCE_3_ENABLED=$(bashio::config 'weather_illuminance_3_enabled')
export WEATHER_ILLUMINANCE_3_NAME=$(bashio::config 'weather_illuminance_3_name')
export WEATHER_ILLUMINANCE_3_DATAPOINT=$(bashio::config 'weather_illuminance_3_datapoint')
export WEATHER_ILLUMINANCE_4_ENABLED=$(bashio::config 'weather_illuminance_4_enabled')
export WEATHER_ILLUMINANCE_4_NAME=$(bashio::config 'weather_illuminance_4_name')
export WEATHER_ILLUMINANCE_4_DATAPOINT=$(bashio::config 'weather_illuminance_4_datapoint')
export WEATHER_TWILIGHT_1_ENABLED=$(bashio::config 'weather_twilight_1_enabled')
export WEATHER_TWILIGHT_1_NAME=$(bashio::config 'weather_twilight_1_name')
export WEATHER_TWILIGHT_1_DATAPOINT=$(bashio::config 'weather_twilight_1_datapoint')
export WEATHER_TWILIGHT_2_ENABLED=$(bashio::config 'weather_twilight_2_enabled')
export WEATHER_TWILIGHT_2_NAME=$(bashio::config 'weather_twilight_2_name')
export WEATHER_TWILIGHT_2_DATAPOINT=$(bashio::config 'weather_twilight_2_datapoint')
